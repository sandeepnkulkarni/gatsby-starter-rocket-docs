...
<img height="200" alt="Kubernetes Logo" src="/dotnetcore.png" />
...
Get started with creating your .Net Core application by clicking [here](/netcore/create-first-dotnetcore-console-app-on-ubuntu).