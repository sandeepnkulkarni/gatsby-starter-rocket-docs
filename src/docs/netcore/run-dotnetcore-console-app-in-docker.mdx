...
Refer to section [Create your first .Net core console application on Ubuntu](/netcore/create-first-dotnetcore-console-app-on-ubuntu) to understand in detail how to create your first .Net Core console application on Ubuntu.
