...
Refer to section Create new console application in [Create your first .Net Core console application on Ubuntu](/netcore/create-first-dotnetcore-console-app-on-ubuntu) to understand basics about how to create .Net Core console application. We will re-use the application created here.
